<?
  session_start();
  $pagtitle = "業務部 &raquo; 更改Clinic";
  include("_data.php");
  include("_erp.php");
  auth("erp_changeclinic.php");
  ...
  if ($_POST["action"] == "save") {
      ...
      foreach ($_POST["oeaarray"] as $oea01){
          if ($_POST["risok" . $oea01] == "Y") {
              ...
              //vd210
              $soea= "update oea_file set ta_oea001='$newpatient' where oea01 = '$oea01'";
...
<table width="100%"  border="0" cellpadding="2" cellspacing="1" class="table4">
  ...
  <?  
      ...
      $soea="select oea01, to_char(oea02,'yyyy/mm/dd') oea02, ta_oea001, oea03, occ02, oea14, gen02, oea99 from oea_file, occ_file, gen_file 
