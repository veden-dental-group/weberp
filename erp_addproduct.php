          ...
          if (is_null($rowocc['XMF07'])) {
              ...
              if (is_null($rowazj['AZJ041'])) {
                  ...
                  if (is_null($rowtcocc['TC_OCC003'])) {
                      ...
                      //寫一個log
                      $queryap   = "insert into erp_addproduct_updaterecord ( oeb01, oeb03, oeb04, oebud03, username, ip ) values ( 
                                    '" . $oeb01        . "',  
                                    '" . $oeb03        . "',      
                                    '" . $oeb04        . "', 
                                    '" . $oebud03      . "',    
                      ...
                      $resultap= mysql_query($queryap) or die ('99 erp_addproduct_updaterecord added error. ' .mysql_error());
                  }
              }   
          }       
      }  
