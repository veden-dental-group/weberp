<?php
  session_start();
  $pagetitle = "業務部 &raquo; 期間內各制處每日到貨統計V4";
  include("_data.php");
  include("_erp.php");
  //auth("erp_alldaterangecasereportv4_bymaker.php");  
  ...
  if ($_GET["submit"]=="E-Mail") {               
      ...
      $filename='report/'.$bdate . '--' . $edate . '_MonthlyCasesByMaker.xls';
      $objWriter->save($filename); 

      // Redirect output to a client’s web browser (Excel5)
      //header('Content-Type: application/vnd.ms-excel');  
      //header('Content-Disposition: attachment;filename="MonthlyCasesByMaker.xls"');    
      ...
      */
      ...
      $mail->Subject = $bdate . '--' . $edate . " 期間內各制處每日到貨統計 ";    
      $mail->Body = $bdate . '--' . $edate . "期間內各制處每日到貨統計 ";  
    ...
    <table width="100%"  border="0" cellpadding="4" cellspacing="1" style="border: 1px solid #cccccc">
      <tr>
        <td bgcolor="#eeeeee"><div align="left">     
            ...
            收件者: <input name="email" type="text" id="email" size='40' onfocus="this.select();" value=<?=$email;?>> &nbsp; &nbsp;  
