<?php
  session_start();
  $pagetitle = "業務部 &raquo; 期間內客戶每日到貨統計V4_英文版";
  include("_data.php");
  include("_erp.php");
              ...
              (select a.oea02, a.ima10, a.ta_oea004,  
               ...
               from  
                 ( select oea02, ima01, ima10, ta_oea004, sum(sfb08*imaud07) sfb08 from 
                     ( select to_char(oea02, 'yyyy-mm-dd') oea02, ima01, imaud01 ima10, imaud07, ta_oea004, sfb08 from sfb_file, oea_file, ima_file
                      where sfb22=oea01 and oea04='$occ01' and oea02 between to_date('$bdate','yy/mm/dd') and  to_date('$edate','yy/mm/dd') and sfb05=ima01 )  
...
*/      
      ...
      $filename  = 'email/' . $bdate . '--' .$edate . '_dailycasessummary.xls';
