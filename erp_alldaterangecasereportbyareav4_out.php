<?php
  session_start();
  $pagetitle = "業務部 &raquo; 期間內每洲出貨合計表V4";
  include("_data.php");
  include("_erp.php");
  //auth("erp_alldaterangecasereportbyareav4_out.php");  
  ...
  if ($_GET["submit"]=="匯出") {   
     ...
     // $bdate1=substr($bdate,2,2).substr($bdate,5,2).substr($bdate,8,2);  
      ...
      header('Content-Disposition: attachment;filename="DateRangeDeliveryCasesbyareav4.xls"');    
