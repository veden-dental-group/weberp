<?php
  ...
  if ($_GET["submit"]=="匯出") {   
      ...
      if ($occ01[0]!='') {          //如果有選中All 就不檢查客戶
          ...
          $occ01selected.="''";          
          $occfilter=" and ( oga04 in ( select occ01 from occ_file where occ07 in (" . $occ01selected . ")) or oga04 in ( select occ01 from occ_file where occ01 in (" . $occ01selected . ")) ) ";     
      }                 
      ...
      header('Content-Disposition: attachment;filename="DailyDeliveryCasesv4-' . $bdate.'.xls"');    
...
<form action="<?=$_SERVER['PHP_SELF'];?>" method="get" name="form1">
  <div align="left">
    <table width="100%"  border="0" cellpadding="4" cellspacing="1" style="border: 1px solid #cccccc">
      <tr><td bgcolor="#eeeeee" width="60">出貨日期:</td>
          <td> 
