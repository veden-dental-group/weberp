<?php
  ...
  if (($_GET["submit"]=="Excel") or  ($_GET["submit"]=="PDF")) {
        ...
        {    //UC-R 要秀Pan No.
                ...
                $y=9;
                $osheet -> setCellValue('A'.$y, "Tracking #:" . $row2["TC_OFAUD03"]);
        ...
        {  // CDM
                ...
                //第二個sheet 放DEF
                $s2="select tc_ofa01, tc_ofa23, tc_ofb11, tc_ofaud03, tc_ofbud05, tc_ofb08, tc_ofb04, tc_ofb06, tc_ofb12, tc_ofb05, tc_ofb13, tc_ofb14, tc_ofb31, tc_ofbud02, tc_ofbud01, tc_ofb31, imaud04, ta_oea001 " .
                    "from tc_ofa_file, tc_ofb_file, ima_file, oga_file, oea_file " .
        ...
        {  // CDM-C
                $s2="select tc_ofa01, tc_ofa23, tc_ofaud03, tc_ofb11, tc_ofbud05, tc_ofb08, tc_ofb04, tc_ofb06, tc_ofb12, tc_ofb05, tc_ofb13, tc_ofb14, tc_ofb31, tc_ofbud02, tc_ofbud01, tc_ofb31, imaud04, ta_oea001 " .
                    "from tc_ofa_file, tc_ofb_file, ima_file, oga_file, oea_file " .
        ...
        { //有patient 有齒位, 有clinic F/HP要加others
            ...
            while ($row2 = oci_fetch_array($erp_sql2, OCI_ASSOC)) {
                ...
                $osheet ->setCellValue('A'. $y, $rxno . ' ')
                        ->setCellValue('C'. $y, $rowoea["TA_OEA001"])
        ...
        { //有patient 有齒位, 有clinic F/HP要加others
        ...
        } else if($template=='F' || $template=='HP')  { //有patient 有齒位, 有clinic F/HP要加others
          ...
          $objPHPExcel->setActiveSheetIndex(0);
            ...
            $osheet -> setCellValue('A'.$y, $row3["OCC231"]);
            $y=8;
            $osheet -> setCellValue('A'.$y, "EORI #  DE27 0841 6650 43649");
            $y=9;
            $osheet -> setCellValue('A'.$y, "Custom # 90 21 29 0000 1");
            $y=10;
            $osheet -> setCellValue('A'.$y, "Tracking #:" . $row2["TC_OFAUD03"]);
