<?php
  ...
  $emailbody=file_get_contents('header_in.html');
  $a811total=0;
  $a821total=0;
  $a831total=0;
  $a8total=0;
  ...
  $query="select occ02, a811, a821, a831, a811+a821+a831 a8 from erp_dailycount where qtype='C' and iotype='IN' and tdate='$bdate' order by occ02 ";
  ...
  while ($row= mysql_fetch_array($result)) { 
      ...
      /*
       <tr>
          <td class="col0">1087</td>
          <td class="col1">2014-04-20</td>
          <td class="col2">A311-1404170931</td>
          <td class="col3">2014-04-18</td>
          <td class="col4">2014-04-18</td>   
        </tr>
       */
       $emailbody .= '<tr>';
  ...
  $emailbody .= '</tr>';       
  $emailbody .= file_get_contents('footer_in.html'); 
...
$filename='email/' . $bdate . '_VD_DailyCasesReceived.xls';    
...
$mail->addAddress('wenhsien.cheng@gmail.com', '鄭董事長'); 
$mail->Subject = 'Veden '. $bdate .' 到貨統計 -- 依客戶別';
