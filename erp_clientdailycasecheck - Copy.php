<?php
  ...
  if ($_GET["submit"]=="NOSD匯出") {   
    ...
    $s2="select to_char(oea02,'mm/dd/yy') oea02, sfb01, sfb05, ima1002, oea01, ta_oea004, ta_oea006, sfb08, sfb82, gem02
  ...
  if ($_GET["submit"]=="一般匯出") {   
    ...
    $s2="select to_char(oea02,'mm/dd/yy') oea02, sfb01, sfb05, ima02, oea01, ta_oea004, ta_oea006, sfb08, occ01, occ02, azf01, azf03, gem01, ta_oea001, ta_oea003, gem02 
