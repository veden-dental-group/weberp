<?php
  ...
  if ($_GET["submit"]=="匯出") {   
    ...
    $filename='templates/casesoutyearlysummary.xls';
    ...
    $s2012="select substr(oea02,1,4) oea02 , decode(substr(oea02,6,2),'01', total, 0) m1,  decode(substr(oea02,6,2),'02', total, 0) m2,  decode(substr(oea02,6,2),'03', total, 0) m3, ".   
             ...
             " (select oea02, sum(total) total from (select to_char(oga02, 'yyyy-mm') oea02, (ogb12 * imaud07) total from ogb_file, oga_file, ima_file where ogb01=oga01 and ogb04=ima01 and ogaconf='Y' ) group by oea02 ) ";
    ...
    $s2012="select decode(oea04,'U132','PLS','U115','FDL','U134','ED','U142','IDS','A114','VL-A','') name, substr(oea02,1,4) oea02 , ".
                                     ...
                                     "decode(substr(oea02,6,2),'07', total, 0) m7,  decode(substr(oea02,6,2),'08', total, 0) m8,  decode(substr(oea02,6,2),'09', total, 0) m9, ". 
                                     "decode(substr(oea02,6,2),'10', total, 0) m10, decode(substr(oea02,6,2),'11', total, 0) m11, decode(substr(oea02,6,2),'12', total, 0) m12 from " .   
          " (select oea04, oea02, sum(total) total from (select substr(oga04,1,4) oea04, to_char(oga02, 'yyyy-mm') oea02, (ogb12 * imaud07) total from ogb_file, oga_file, ima_file where ogb01=oga01 and ogb04=ima01 and ogaconf='Y' and substr(oga04,1,4) in ('U132','U115','U134','U142','A114') ) group by oea04, oea02 ) ";
