<?php
  session_start();
  $pagetitle = "業務部 &raquo; 期間內每洲出貨合計表V3";
  include("_data.php");
  include("_erp.php");
  //auth("erp_alldaterangecasereportbyareav3_out.php");  
  ...
  if ($_GET["submit"]=="匯出") {   
      ...
      $objPHPExcel = $objReader->load("templates/erp_daterangecasesbyareav3.xls");
      $objPHPExcel->setActiveSheetIndex(0)    
                  ->setCellValue('A1', $bdate.'--'.$edate)  
                  ->setCellValue('B1', "期間內各區域出貨合计表");     
      ...
      $s2="select gea02, 
        ...
        from 
          (select a.gea02, a.ima10, a.ta_oea004,  
            ...
            decode((a.ima10||a.ta_oea004),'82ZZ32',a.sfb08, 0) as a82ZZ2,
            decode((a.ima10||a.ta_oea004),'82ZZ33',a.sfb08, 0) as a82ZZ3,
           ...
           from  
             ( select gea02, ima01, ima10, ta_oea004, sum(sfb08*imaud07) sfb08 from 
                 ( select gea02, ima01, imaud01 ima10, imaud07, ta_oea004, sfb08 from sfb_file, oea_file, oga_file, ima_file, occ_file, gea_file
                  where sfb22=oea01 and oea01=oga16 and oga02 between to_date('$bdate','yy/mm/dd') and  to_date('$edate','yy/mm/dd') and sfb05=ima01 and oea04=occ01 and occ20=gea01 )  
               group by gea02, ima01, ima10,ta_oea004) a)
           group by gea02 order by gea02 ";  
      ...
      $objPHPExcel->getActiveSheet()->setTitle('DateRangeCasesByArea--by Unit');
     ...
     // $bdate1=substr($bdate,2,2).substr($bdate,5,2).substr($bdate,8,2);  
      $s2="select gea02, sum(a11) a11, sum(a12) a12, sum(a13) a13, sum(a21) a21, sum(a22) a22, sum(a23) a23 from
           (select gea02,
           ...
           from
            (select gea02, ta_oea006, ta_oea011, ta_oea004 from oea_file, oga_file, occ_file, gea_file where oea01=oga16 and oga02 between to_date('$bdate','yy/mm/dd') 
             and to_date('$edate','yy/mm/dd') and oea04=occ01 and occ20=gea01  )a ) group by gea02 order by gea02";   
      $erp_sql2 = oci_parse($erp_conn1,$s2 );
      oci_execute($erp_sql2);         
      $y=3;   
      $t=array('    ','A1','A2');                               
      ...
      $objPHPExcel->getActiveSheet()->setTitle('WeeklyCases--by Order');                                                                
      ...
      header('Content-Disposition: attachment;filename="DateRangeDeliveryCasesbyareav3.xls"');    
