			...
			if (d.valueAxis == this) {
				...
				if (!isNaN(a.startTime) && (l = a.categoryAxis)) {
					...
					var m = new Date(a.startTime + minDuration / 2),
						p = AmCharts.resetDateToMin(new Date(a.startTime), l.minPeriod).getTime();
					AmCharts.resetDateToMin(new Date(m), l.minPeriod).getTime() > p && g++
				}
				...
				for (e = k; e <= h; e++) {
					...
					var k = g.values,
						n;
					for (n in k) g.percents[n] = "percents" != n ? k[n] / f * 100 - 100 : k[n]
				}
			}
		}
	},
	...
	detectMovement: function() {
		...
		if (a.mouseIsOver) {
			var b = a.mouseX - this.x,
				c = a.mouseY - this.y; - 0.5 < b && b < this.width + 1 && 0 < c && c < this.height ? (this.drawing ? this.rolledOver || a.setMouseCursor("crosshair") : this.pan && (this.rolledOver || a.setMouseCursor("move")), this.rolledOver = !0, this.setPosition()) : this.rolledOver && (this.handleMouseOut(), this.rolledOver = !1)
