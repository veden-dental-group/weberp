<?php
  ...
  if (($_GET["submit"]=="Excel") or  ($_GET["submit"]=="PDF")) {
      ...
      //$type=$row2['OCCUD11'];
      //
      //20150702 E184001 NOSD 要加印shade, teeth
      if ($bocc01=='E184001') {
          $filename="templates/shippingadvicef_E184001.xls";
      } else if ($bocc01=='E181002') {
          $filename="templates/shippingadvicef_E181002.xls";
      } else if ($bocc01=='E181003') {
          $filename="templates/shippingadvicef_E181003.xls";
      } else if ($bocc01=='E181004') {
          $filename="templates/shippingadvicef_E181004.xls";            
      } else {
      ...
      //E184002 CDM 的shipping advice ABC 放到sheet 0  DEF 放到sheet 1
      if ($bocc01=='E181002') { 
          ...
          $s2="select ogaud02, ta_oea003, ta_oea001, ima1002, metalno, metal, ima021, tc_dex004, ogb12, shade, oebud03  from " .
                "( select oga01, ogb03, ogaud02, ta_oea003, ta_oea001, ima1002, ogb12, (ta_oea046||ta_oea047||ta_oea048) shade, oebud03 " .
                   "from oga_file, ogb_file, ima_file, oea_file, oeb_file where substr(ogb04,1,1)='1' and upper(substr(ta_oea001,1,1)) in ('A','B','C') and oga16=oea01 and ogb04=ima01 and oga01=ogb01 and ogb31=oeb01 and ogb32=oeb03  " . $datefilter . $occfilter . " ) " .
                "left join " .
                ...
                "order by upper(ta_oea001), ogaud02  ";
          $i=0;
          $y=8;
          $totalcase=0;
          $totalunit=0;
          ...
          $s2="select ogaud02, ta_oea003, ta_oea001, ima1002, metalno, metal, ima021, tc_dex004, ogb12, shade, oebud03  from " .
                "( select oga01, ogb03, ogaud02, ta_oea003, ta_oea001, ima1002, ogb12, (ta_oea046||ta_oea047||ta_oea048) shade, oebud03 " .
                   "from oga_file, ogb_file, ima_file, oea_file, oeb_file where substr(ogb04,1,1)='1' and upper(substr(ta_oea001,1,1)) in ('D','E','F') and oga16=oea01 and ogb04=ima01 and oga01=ogb01 and ogb31=oeb01 and ogb32=oeb03  " . $datefilter . $occfilter . " ) " .
                "left join " .
                "(select tc_dex001, tc_dex002, tc_dex003 metalno, ima1002 metal, ima021, tc_dex004 from tc_dex_file, ima_file where tc_dex003=ima01 and imaud10 is not null ) " .
                "on oga01=tc_dex001 and ogb03=tc_dex002 " .
                "order by upper(ta_oea001), ogaud02  ";
        ...
        //F秀合計
          $osheet ->setCellValue('B'. $y, "TOTAL:")
                  ...
                  ->setCellValue('I'. $y, $totalunit)
                  ->setCellValue('J'. $y, "UNITS");
          // Set active sheet index to the first sheet, so Excel opens this as the first sheet          //第四個sheet 取DEF
        ...
        //F秀合計
          ...
          $s2="select ogaud02, ta_oea003, ta_oea001, ima1002, metalno, metal, ima021, tc_dex004, ogb12, shade, oebud03  from " .
            "( select oga01, ogb03, ogaud02, ta_oea003, ta_oea001, ima1002, ogb12, (ta_oea046||ta_oea047||ta_oea048) shade, oebud03 " .
               "from oga_file, ogb_file, ima_file, oea_file, oeb_file where substr(ogb04,1,1)='1' and oga16=oea01 and ogb04=ima01 and oga01=ogb01 and ogb31=oeb01 and ogb32=oeb03  " . $datefilter . $occfilter . " ) " .
            "left join " .
            "(select tc_dex001, tc_dex002, tc_dex003 metalno, ima1002 metal, ima021, tc_dex004 from tc_dex_file, ima_file where tc_dex003=ima01 and imaud10 is not null ) " .
            "on oga01=tc_dex001 and ogb03=tc_dex002 " .
            "order by ta_oea001, ogaud02  ";
          ...
          while ($row2 = oci_fetch_array($erp_sql2, OCI_ASSOC)) {
            ...
            if ($bocc01=='E184001') {
                $osheet ->setCellValue('K'. $y, $row2["OEBUD03"])
