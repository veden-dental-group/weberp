...
$filename='email/' . $edate . '_DeliveriedCasesReport.xls';
...
if ($i>0) {          
    ...
    $m->send("frank@vedenlabs.com", $edate . ' Deliveried Cases Report') ;  
    //$m->send("cs@vedenlabs.com", $edate . ' Deliveried Cases Report') ;  
    //$m->send("m@vedenlabs.com", $edate . ' Deliveried Cases Report') ;   
    //$m->send("fa2@vedenlabs.com", $edate . ' Deliveried Cases Report') ;    
}
