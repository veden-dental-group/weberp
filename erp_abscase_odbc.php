...
$s1= "select tc_srg002, ecb06, oea01 " .
     ...
     "where tc_srg003=ecb01 and tc_srg004=ecb03 and tc_srg001=sfb01 and sfb22=oea01 ";
...
while ($row1 = oci_fetch_array($erp_sql1, OCI_ASSOC)) {
  ...
  if (mysql_num_rows($resultu) == 0) {                         
    ...
    $odbc_sql= "insert into ABSDataShare (CASENUMBER,VDROPSHIP, VSTATUS, VDATEUPDATED, VTRACKINGNUM)
