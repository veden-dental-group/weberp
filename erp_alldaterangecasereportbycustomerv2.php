<?php
  ...
  include("_data.php");
  include("_erp.php");
 // auth("erp_alldaterangecasereportbycustomerv2.php");  
  ...
  if ($_GET["submit"]=="匯出") {  
      ...
      $objPHPExcel = $objReader->load("templates/erp_daterangecasesbycustomerv2.xls");    
     ...
     // $bdate1=substr($bdate,2,2).substr($bdate,5,2).substr($bdate,8,2);  
      ...
      header('Content-Disposition: attachment;filename="DateRangeCasesbycustomerv2.xls"');    
