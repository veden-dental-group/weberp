...
$s2= "select sfb82, gem02, sfbud02, sfb22, sfb221, sfb01, to_char(sfb81,'mm-dd-yyyy') sfb81,  to_char(ta_oea005,'mm-dd-yyyy') ta_oea005, sfb05, ima02, occ01, occ02 " .
...
while ($row2 = oci_fetch_array($erp_sql2, OCI_ASSOC)) {   
    ...
    $objPHPExcel->setActiveSheetIndex(0)     
                ...
                ->setCellValue('D'. $y, $sfb22)                   
                ->setCellValue('E'. $y, $row2['SFB221'])
                ...
                ->setCellValue('J'. $y, '')      
                ->setCellValue('K'. $y, '')      
                ->setCellValue('L'. $y, $row2['SFB05'].'--'.$row2['IMA02'])      
                ->setCellValue('M'. $y, '')      
                ->setCellValue('N'. $y, '')      
                ->setCellValue('O'. $y, $nowstage)      
                ->setCellValue('P'. $y, $row2['OCC01'].'--'.$row2['OCC02'])      
                ->setCellValue('Q'. $y, '')      
                ->setCellValue('R'. $y, '');  
    if (($y%2)==0){
...
if ($j>0) {          
    ...
    $m->send("fa3@vedenlabs.com", $edate . ' delay cases') ;    
}
