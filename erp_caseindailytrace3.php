<?
  session_start();
  $pagtitle = "廠務部 &raquo; 每日到貨CASE刷卡報工出貨追蹤"; 
  include("_data.php");
  include("_erp.php");
  // auth("erp_caseindailytrace3.php");   
  $tdate=$_GET['tdate'];      
  $maker=$_GET['maker']; 
  //$issent=$_GET['issent']; 
  $issent='';
  ...
  $objPHPExcel->setActiveSheetIndex(0)
              ->setCellValue('A1', $thisyear.' 每日到貨CASE刷卡報工出貨追蹤');       
  ...
  $s1="select oea02,  sfb01, sfb22, sfb221, sfb82, gem02, sfb05, sfbud02, ima02, ecb06, ecb17, tc_srg004, tc_srg005, tc_srg007, tc_srg008, tc_srg010, tc_srg011, ogb03, tc_ohf004 from " .  
          ...
          "left join ogb_file on sfb22=ogb31 and sfb221=ogb32 where 1=1 $issentfilter $isecb06filter ) " .
    ...
    $objPHPExcel->getActiveSheet()->setTitle('每日到貨CASE刷卡報工出貨追蹤');
