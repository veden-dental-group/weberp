<?
  ...
  $stclod="select tc_lod001, tc_lod002, to_char(tc_lod003,'yymmdd') tc_lod003, tc_lod004, tc_lod005, tc_lod006, tc_lod007, tc_lod008, tc_lod009, tc_lod010, tc_lod011, tc_lod012, tc_lod013
           from tc_lod_file order by tc_lod004,tc_lod003,tc_lod005 "; 
          ...
          if ($tc_lod005old!='') {  //第一筆不用寫入資料 
              ...
              for ($x=0; $x<$i; $x++){
                  if (substr($tc_lod006[$x],0,1)!='M') {  
                      ...
                      $stcloe="insert into tc_loe_file values ('$tc_loe001',$ii, to_date('$tc_loe003','yy/mm/dd'),'$tc_loe004','$tc_loe005','$tc_loe006','$tc_loe007',$tc_loe008,$tc_loe009,$tc_loe010,'$tc_loe011','$tc_loe012','$tc_loe013','','','','','','','','','','',$tc_loe014  ) "; 
