...
// $edate=date('Y-m-d');
$edate = $argv[1] ? $argv[1] : date('Y-m-d');
//$edate='2012-09-14';
//先刪除同一日期的所有資料
...
$filename='report/' . $edate . '_DeliveriedCasesReportv3.xls';
$objWriter->save($filename);

  $report_name = $edate . ' 出貨顆床數統計';
  ...
  $mail->addAddress('chris.lee@veden.dental', 'Veden');
  $mail->addAddress('ck.chang@veden.dental', 'Veden');
