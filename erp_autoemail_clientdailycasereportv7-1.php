<?php
      ...
      (select a.occ07, a.ima10, a.ta_oea004,  
       ...
       from  
         ( select occ07, ima01, ima10, ta_oea004, sum(sfb08*imaud07) sfb08 from 
             ( select occ07, ima01, imaud01 ima10, imaud07, ta_oea004, sfb08 from sfb_file, oea_file, ima_file, occ_file 
  ...
  $s2="select occ07, sum(a11) a811, sum(a12) a812, sum(a13) a813, sum(a21) a821, sum(a22) a822, sum(a23) a823, sum(a31) a831, sum(a32) a832, sum(a33) a833 from
       ...
       from
        (select occ07, ta_oea006, ta_oea011, ta_oea004 from oea_file, occ_file where oea02=to_date('$bdate','yy/mm/dd') and oea04=occ01 )a ) group by occ07 order by occ07";   
